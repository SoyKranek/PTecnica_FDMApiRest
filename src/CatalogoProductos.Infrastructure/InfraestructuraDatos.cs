...
namespace CatalogoProductos.Infrastructure
{
    ...
    public static class InyeccionDependenciasInfrastructure
    {
        ...
        private static string ConvertirUriAConnectionString(string databaseUri)
        {
            ...
            return $"Host={host};Port={port};Database={database};Username={username};Password={password};SSL Mode=Require;Trust Server Certificate=true;Pooling=true;Timeout=30;Include Error Detail=true";
        }
    }
}
